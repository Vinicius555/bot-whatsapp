"""
 PRECISO AUTOMATIZAR MINHAS MENSAGENS P/ MEUS CLIENTES GOSTARIA DE SABE VALORES,E GOSTARIA QUE ENTRASSEM EM CONTATO
 COMIG P/ EXPLICAR MELHOR,QUERO PODER MANDAR MENSAGENS DE COBRANÇA EM DETERMINADO DIA COM
